...
def main():
    """
    prototype's main method
    :return:
    """
    data_dir = '/SNS/users/wzz/Projects/HB2B/Quasi_HB2B_Calibration'

    # TODO
    # 1. load TIFF & XLS
    # 2. convert to standard hdf5
    # 3. load new IDF txt
    # 4. construct instrument
    # 5. reduce data and compare adjacent patterns
    # 6. fit peaks
    # 7. figure out a good cost function!
