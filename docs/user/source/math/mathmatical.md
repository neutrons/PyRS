...
The stress/strain UI in pyRS allows for users to impose a 2D plane stress ($\sigma_{33}=0$) or plane-strain ($\epsilon_{33}=0$) conditions.
...
pyRS also calculates $\epsilon_{33}$ for visualization purpose.
