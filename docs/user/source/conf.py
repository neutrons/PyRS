# -*- coding: utf-8 -*-
#
# PyRS documentation build configuration file
#
...
latex_documents = [
    (master_doc, "PyRS.tex", "PyRS Documentation", "William F Godoy", "manual"),
]
...
man_pages = [(master_doc, "PyRS", "PyRS Documentation", [author], 1)]
...
texinfo_documents = [
    (master_doc, "PyRS", "PyRS Documentation", author, "PyRS", "One line description of project.", "Miscellaneous"),
]
