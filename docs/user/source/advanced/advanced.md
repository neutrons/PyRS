...
This project file shall store information about measured diffraction patterns (intensity vs $2\theta$) and results from single peak fitting.
...
- reduced diffraction data
  - 2theta
    - $2\theta$ vectors for each sub-run
  - main
