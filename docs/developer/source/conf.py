...
# Ensure the 'pyrs' package is in the path:
# - current dir is `docs/developer/source`.
...
# Both are kept because `api/modules.rst` is auto-generated reStructuredText
# by sphinx-apidoc (see `run_apidoc` below); hand-written pages are Markdown (MyST).
source_suffix = {
...
exclude_patterns = [".pixi", "**/.pixi", "_build", "build", "reference"]
...
latex_documents = [
    (master_doc, "PyRS_dev.tex", "PyRS Developer Documentation", "PyRS developers", "manual"),
]
...
man_pages = [(master_doc, "PyRS_dev", "PyRS Developer Documentation", [author], 1)]
...
def run_apidoc(_):
    ...
    # current_dir = docs/developer (where conf.py is)
    current_dir = os.path.abspath(os.path.dirname(__file__))

    # module_dir = neutrons/PyRS/pyrs (the python source code)
    module_dir = os.path.join(project_dir, "pyrs")

    # output_dir = docs/developer/api
