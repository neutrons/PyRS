...
def test_main_2d():
    ...
    ss_window.do_check_exp_grids_alignment()   # e33=False, sample_resolution=(0.01, 0.01, 0.01))
    ...
    grid_info_window = ss_window.set_3D_viz_grid(direction='e22', user_define_flag=False, grids_setup_dict=setup_dict,
...
def test_main_plane_stress():
    ...
    # start a new project
    ss_window.create_new_session('test_strain_stress', False, True)
