...
def test_main():
    ...
    test_data = 'data/Hydra_16-1_cor_log.h5'
    ...
    # Get sub runs
    sub_runs = rs_core.reduction_manager.get_sub_runs('test core')
    assert sub_runs

    # Get sample logs
    log_names = rs_core.reduction_manager.get_sample_logs_names('test core', None)
