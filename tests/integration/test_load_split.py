...
def test_log_time_average():
    ...
    exp_times = np.array(
        [
            "2019-11-10T16:31:02.645235328-0500",
            "2019-11-10T16:41:02.771317813-0500",  # scan_index=1
            "2019-11-10T16:41:14.238680196-0500",
            "2019-11-10T17:11:14.249705287-0500",  # scan_index=2
            "2019-11-10T17:11:33.208056929-0500",
            "2019-11-10T17:31:33.218615767-0500",
        ],  # scan_index=3
        dtype="datetime64[ns]",
    )
    ...
    exp_durations = np.array([600.0, 1800.0, 1200.0])
    ...
    np.testing.assert_allclose(sample_logs["2theta"], [69.99525, 80.0, 97.50225])
