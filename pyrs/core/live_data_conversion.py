...
class Splitter:
    ...
    def __init__(self, runObj):
        ...
        scan_index_times = runObj.getProperty('scan_index').times   # absolute times
        scan_index_value = runObj.getProperty('scan_index').value
...
class LiveConvertingApp:
    """
    Convert NeXus file to Hidra project file
    """
    def __init__(self, live_wsp, mask_file_name=None, extra_logs=list()):
        """Initialization
